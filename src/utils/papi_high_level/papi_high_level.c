...
int main()
{
   ...
   /* Read performance events at THE BEGINNING of a region 
      (the first call also starts counting the events)
   */
   ...
   /* Read performance events INSIDE of a region 
      and store the difference to the corresponding beginning of the region
   */
   ...
   /* Read performance events at THE END of a region 
      and store the difference to the corresponding beginning of the region
   */
