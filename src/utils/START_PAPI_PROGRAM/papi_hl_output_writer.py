# Questo programma è stato scritto in Python2. Ho fatto le modifiche seguenti:
# - cambiato i long in int
# - ho scambiato le condizioni alla riga 101
...
class Sum_Counter(object):
  ...
  def add_event(self, value):
    if isinstance(value, dict):
      if self.min > int(value['min']) or self.min is None:
