...
plot "results.rapl:::DRAM_ENERGY:PACKAGE0" using 1:2 title "DRAM" with linespoints, \
     "results.rapl:::PACKAGE_ENERGY:PACKAGE0" using 1:2 title "PACKAGE" with linespoints, \
     "results.rapl:::PP0_ENERGY:PACKAGE0" using 1:2 title "PP0" with linespoints
